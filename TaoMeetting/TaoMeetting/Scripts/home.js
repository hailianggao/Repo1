function load_animations(){
			...
			if (!$.browser.msie) {
			    $('#header_images').css({ height: '250px', opacity: '0' })
				$('#aside2').css({height:'558px', opacity:'0'});
				$('#overlay_bg').css({ height: '250px' });
			    ...
			    $('#header_images').css({ height: '250px' });
		...
		if (!$.browser.msie) {
			$('#header_images > .header_image:nth-child('+current_project+')').stop().animate({opacity:'0',marginLeft:'-100px',marginTop:'-50px',width:'1210px',height:'590px'},250,'easeInQuad', function(){
			    $(this).css({ marginLeft: '0px', marginTop: '0px', width: '632px', height: '250px' })			
			...
			$('#header_images > .header_image:nth-child(' + current_project + ')').stop().animate({ opacity: '1', marginLeft: '0', marginTop: '0', width: '632px', height: '250px' }, 250, 'easeOutQuad');
			});
		}
		else{
